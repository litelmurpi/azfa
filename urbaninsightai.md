...
| **Frontend/UI Engineer**        | Next.js setup, MapLibre GL JS integration, layer system, simulation viewer (Canvas + WebSocket), analytics dashboard, responsive UI polish |
...
| Frontend Engineer | Setup Next.js 14 project, design system (TailwindCSS), component library, routing structure.                        |
